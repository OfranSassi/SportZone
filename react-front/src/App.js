...
//  console.log(users);
 ...
 return (
  <Routes>
   ...
   {/* <Route path='/coach/events' element={<Events />} /> */}
   <Route path='/coach-invitation' element={<Mailer />} />

   <Route path='/coach/sessions/rejectfeedback' element={<RejectFeedback />}
   />
   ...
   />
   {/* <Route path='/coach/players' element={<Cplayers />} /> */}
   <Route path='/manage-players' element={<Players />} />
   <Route
    path='/coach-challenges'
    element={<AsignedChallenge />}
   />
